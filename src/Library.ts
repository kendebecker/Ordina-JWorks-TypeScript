class Library {
    ...
    constructor() {
        ...
        let playerOne: Book = new Book(new Author("Ernest Cline"), "Ready player one", "Sfi-fi adventure", "");
        let gameOfThrones :Book = new Book(new Author("George RR Martin"),"Game of Thrones","Fantasy","Only pla to win");
